...
inline void print_rect(const char* msg, Rect& rect) {
  debug_message(msg << " <Rect " << rect.ul_x() << " " << rect.ul_y() << 
		" " << rect.lr_x() << " " << rect.lr_y() << ">");
}
inline void print_array(const char* msg, const IntVector* array) {
...
inline void print_rect(const char* msg, Rect& rect) {}
inline void print_array(const char* msg, IntVector* array) {}
#endif
